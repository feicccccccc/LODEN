...
if __name__ == "__main__":
    ...
    init_conditions = [
        (1, 0, 0, 2. * np.pi, 500),  # TODO: LNN need more trajectory
        (2, 0, 0, 2. * np.pi, 500),
        (0.5, 0, 0, 2. * np.pi, 500),
        (1.5, 0, 0, 2. * np.pi, 500)
    ]
    dataModule = SHM_1D_LNN_DataModule(init_conditions=init_conditions, batch_size=128)  # TODO: try different data set
    dataModule.setup()
    ...
    class Learner(pl.LightningModule):
        ...
        def training_step(self, batch, batch_idx):
            # TODO: Investigate different behaviour of getting dqdt. For example Finite difference.
            x, y, _ = batch
