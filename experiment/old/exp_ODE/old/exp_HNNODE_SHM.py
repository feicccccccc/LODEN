...
Learning Hamiltonian directly from trajectory
...
if __name__ == "__main__":
    ...
    dataModule = SHM_1D_ODE_DataModule(init_conditions=init_conditions, time_horizon=50)
    dataModule.setup()
    # dataModule.plot_data(train=True)

    # Network for estimate the ODE
    HamFunc = HNN(0, MLP([2, 64, 1], activation='sigmoid'))
