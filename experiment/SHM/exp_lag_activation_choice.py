...
lagFunc_logsigmoid = LNN(num_angle=0, lagrangianNet=MLP([2, 32, 33, 1], activation='logsigmoid'))
lagODE_logsigmoid = NeuralODE(lagFunc_logsigmoid, sensitivity='adjoint', solver='rk4').to(device)
...
models = [lagODE_logsigmoid, lagODE_softplus]
...
torch.save(models, "model/lag_activation.pt")
