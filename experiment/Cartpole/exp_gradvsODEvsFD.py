...
pre_learner = LNNFDLearner(lagODE)
...
torch.save(lagODE, "model/gradvsODEvsFD_lagODE.pt")

for learner in learners:
    early_stopping = EarlyStopping('val_loss', verbose=False, min_delta=min_delta, patience=patience)
    trainer = pl.Trainer(callbacks=[early_stopping], min_epochs=100, max_epochs=15000)
