...
if __name__ == "__main__":
    ...
    # learn = HNNLearner(hamODE)
    # learn = HNNFDLearner(hamODE)
    # learn = LNNLearner(lagODE)
    # learn = LNNFDLearner(lagODE)
    # learn = ODELearner(lagODE, 2)

    # learn = ODELearner(baselineODE, 7)
    # learn = LNNLearner(baselineODE)
    # learn = LNNFDLearner(baselineODE)

    # pre_trainer = pl.Trainer(max_epochs=100)
    # pre_trainer.fit(learn, dataModule)
